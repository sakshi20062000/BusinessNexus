...
<body>
<div class="container">
    <a href="Notifications" style="text-decoration: none;" class="one">
        <span class="fa fa-long-arrow-left" aria-hidden="true"></span>
        <h5>Back</h5>
    </a>
    <div class="two">
        <h4>Community</h4>
        <p>These are notifications that someone invited or approved you to join a group</p>
    </div>
    <div class="three">
        <p>Allow Group Notifications</p>
        <div>
            <p>Push, In-app, Email</p>
            <label class="toggle">
