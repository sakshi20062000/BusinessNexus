    ...
    <body>
        <div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px;padding-left: 40px">
            ...
            <div class="two" style="margin: 25px 0 0 0;">
                <h4 style="font-size: 17px;">Allow Profile Improvement Notifications</h4>
                <p style="font-size: 14px">These are notifications about ways to complete your profile, such as adding education, industry or photo</p>
            </div>
            <div class="three" style="margin: 25px 0 0 0;">
                <p>Allow Profie Improvement Notifications</p></div>
