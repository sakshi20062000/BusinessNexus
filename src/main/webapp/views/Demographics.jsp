...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .container {
                width: 90%; /* Reduce the container width for smaller screens */
            }

            .toggle {
                width: 40px; /* Reduce the toggle width */
                height: 24px; /* Reduce the toggle height */
            }

            .toggle-slider {
                width: 24px; /* Reduce the toggle slider width */
                height: 24px; /* Reduce the toggle slider height */
            }
        }
    </style>
</head>
...
<div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px; padding-left: 40px">
    ...
    <div class="two" style="margin: 25px 0 0 0;">
        <h4 style="font-size: 17px;">Demographics</h4>
        <p>Can we use your age to show you relevant ads?</p>
    </div>
    <div class="three" style="display: flex;">
        <p>Use your age for ads</p>
    ...
    <div class="three" style="margin: 25px 0 0 0;">
        <p>Can we use your gender to show you relevant ads?</p>
    </div>
    <div class="four" style="display: flex;">
        <p style="white-space: nowrap;">Use your gender for ads</p>
        <div style="display: flex; justify-content: space-between; margin-left: 375px;">
