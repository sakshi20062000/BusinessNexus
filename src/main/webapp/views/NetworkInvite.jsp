...
<head>
    ...
    <style>
        ...
        .toggle {
            ...
            display: flex;
            align-items: center;
            padding-left: 5px; /* Added padding for left alignment */
        }
        ...
        /* Style for labels */
        .toggle-label {
            margin-right: 10px; /* Added margin between labels and toggle buttons */
        }
    </style>
</head>
<body>
...
<div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px; padding-left: 40px">
    ...
    <div class="two" style="margin: 25px 0 0 0;">
        <h4 style="font-size: 17px;">Network Invites</h4>
        <p>Allow your network to send you page invitations to follow companies and organizations?</p>
    </div>
    <div class="three" style="display: flex; align-items: center;">
        <p class="toggle-label">Allow page invitations</p>
        <label class="toggle">
    ...
    <div class="four" style="display: flex; align-items: center;">
        <p class="toggle-label">Allow event invitations</p>
        <label class="toggle">
            <input type="checkbox" onchange="toggleAds(this, 'adsStatus2')">
            <span class="toggle-slider"></span>
        </label>
        <p><span id="adsStatus2">Off</span></p>
    </div>
    <div class="five" style="margin: 25px 0 0 0;">
        <p>Allow your network to send you invitations to subscribe to newsletters?</p>
    </div>
    <div class="six" style="display: flex; align-items: center;">
        <p class="toggle-label">Allow newsletters invitations</p>
        <label class="toggle">
            <input type="checkbox" onchange="toggleAds(this, 'adsStatus3')">
            <span class="toggle-slider"></span>
        </label>
        <p><span id="adsStatus3">Off</span></p>
    </div>
</div>
