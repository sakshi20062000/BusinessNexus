...
<main  style="display: flex; justify-content:space-between;" class="">
            ...
            <div style="padding-top:2%;  position: unset;">
                <div class="row mt-8" style="padding-left: 1%; width: 100%;">
                    ...
                    <div class="col-md-9">
                        <!-- categories -->
                        <div class="list-group"
                             style="background-color: white; padding-right: 10%; border-radius: 5px;  align-items: flex-start;height: auto; padding: 6%; padding-top: 10px; margin-left:20px ">
    ...
    <!-- Main section starts -->
    <div class="col-md-10">
        <div class="list-group" style="padding-top: 20px; margin-left: 10px; margin-top: -290px">
            <div class="container">
                <!-- Center the row -->
