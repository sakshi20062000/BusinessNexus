...
<html>
    ...
    <body oncontextmenu='return false' style="background: linear-gradient(to left, #FFFFFF, #99b3ff); color: #000000;">
                        ...
                        <div class="container bg-white rounded mt-2 mb-2 px-0">
                            ...
                            <div class="mx-0 px-0 bg-light">
                                ...
                                <div class="pt-2">
                                    <div class="row justify-content-center">
                                        <h5>
                                            Don't have an Account?<span><a href="register_page.jsp"
