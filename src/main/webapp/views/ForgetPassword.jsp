...
<html>
    ...
    <body oncontextmenu='return false' class='snippet-body' style="background: linear-gradient(to left, #FFFFFF, #99b3ff); color: #000000;">
        <div class="container padding-bottom-3x mb-2 mt-5">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    ...
                    <form class="card mt-4" action="EnterOtp" method="post">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="email-for-pass">Enter your email address</label> 
                                <input class="form-control" type="text" name="email" id="email-for-pass" required="@gmail.com"><small
