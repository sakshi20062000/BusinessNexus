...
<div class="container" style="border: 1px solid black; width: 60%; margin: 50px auto; padding-left: 40px;">
    ...
    <div class="three" style="display: flex; align-items: center;">
        <p style="white-space: nowrap; margin-right: 10px;">Use data you've given to businesses</p>
        <label class="toggle" style="margin-right: 10px;">
            <input type="checkbox" onchange="toggleAds(this, 'adsStatus1')">
            <span class="toggle-slider"></span>
        </label>
        <span id="adsStatus1" style="">Off</span>
    </div>
</div>
