        ...
        <div class="row justify-content-center">
            <div class="sidebar" style="margin-top: 30px;padding: 40px;border: 2px solid black">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link c-link list-group-item-action" href="Change_Password.jsp" onclick="getPosts(2, '')" style="font-size: 20px; padding-left: 40px;">Change Password<i class="fa fa-long-arrow-right" style="padding-left: 395px;" aria-hidden="true"></i></a>
                    </li>
                </ul>
            </div>
        </div>
