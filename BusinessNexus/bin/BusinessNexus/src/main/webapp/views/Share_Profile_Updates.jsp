    ...
    <body>
       ...
       <div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px;padding-left: 40px">
            ...
            <div class="two" style="margin: 25px 0 0 0;">
                <h4 style="font-size: 17px;">Sharing Profile Edits</h4>
            </div>
            <div class="three" style="display: flex;">
                <p style="white-space: nowrap;">Sharing key profile updates</p>
                <div style="display: flex; justify-content: space-between; margin-left: 350px;">
