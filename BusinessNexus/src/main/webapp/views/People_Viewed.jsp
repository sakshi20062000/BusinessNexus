    ...
    <body>
       ...
       <div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px;padding-left: 40px">
            ...
            <div class="two" style="margin: 25px 0 0 0;">
                <h4 style="font-size: 17px;">People also Viewed</h4>
                <p>Display "People also viewed" box on your Profile page?</p>
            </div>
            <div class="three" style="display: flex;">
                <p>People also viewed</p>
                <div style="display: flex; justify-content: space-between; margin-left: 450px;">
