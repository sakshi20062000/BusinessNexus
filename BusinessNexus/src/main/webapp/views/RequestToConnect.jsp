    ...
    <body>
       ...
       <div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px;padding-left: 40px">
            ...
            <div class="two" style="margin: 25px 0 0 0;">
                <h4 style="font-size: 17px;">Request To Connect</h4>
                <p>Who can send you invitations to connect?</p>
            </div>
            <div class="three" style="display: flex;">
              <p style="white-space: nowrap;">Everyone on Business Nexus(recommended)</p>
                <div style="display: flex; justify-content: space-between; margin-left: 235px;">
            ...
            <div class="three" style="margin: 25px 0 0 0;">
                <p>people who know your email address</p>
            </div>
            <div class="four" style="display: flex;">
                <p style="white-space: nowrap;">Only people who appear in your "Imported Contact" list</p>
                <div style="display: flex; justify-content: space-between; margin-left:155px;">
