    ...
    <body>
        ...
        <div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px;padding-left: 40px">
            ...
            <div class="three" style="display: flex;">
                <p style="white-space: nowrap;">Allow page invitations</p>
            ...
            <div class="four" style="display: flex;">
                <p style="white-space: nowrap;">Allow event invitations</p>
                <div style="display: flex; justify-content: space-between; margin-left: 390px;">
            ...
            <div class="six" style="display: flex;">
                <p style="white-space: nowrap;">Allow newsletters invitations</p>
                <div style="display: flex; justify-content: space-between; margin-left: 355px;">
