    ...
    <body>
        ...
        <div class="container" style="border: 1px solid black; width: 60%; margin: 50px 0 0 200px;padding-left: 40px">
            ...
            <div class="two" style="margin: 25px 0 0 0;">
                <h4 style="font-size: 17px;">Export Your Data</h4>
                <p>Your Investor Lobby data belongs to you, and you can download an archive any time</p>
            </div>
            <div class="three" style="display: flex;">
                <p>Your Data <a href="path/to/download" download><button class="btn btn-primary" style="margin-left:200px">Download</button></a></p>
            </div>
    </body>
</html>
